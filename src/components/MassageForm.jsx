    ...
    <>
      ...
      >
        <form onSubmit={handleSubmit}>
          ...
          <div className="text-center font-black text-lg md:text-2xl uppercase my-20">
            <span className="px-6 md:px-10 py-4 border-lightGreen border rounded-md shadow-md">
              {" "}
              {t("discover")}
            </span>
          </div>
