...
const MoreOfMarrakeshForm = () => {
  ...
  const { t } = useTranslation("moreOfMarrakesh");
  ...
  return (
    <>
      <Helmet>
        <title>Yanis Guest House more activities page</title>
        <meta name="description" content="more activities page" />
        <link rel="canonical" href="/moreOfMarrakeshForm" />
      </Helmet>
      <motion.div
...
export default MoreOfMarrakeshForm;
