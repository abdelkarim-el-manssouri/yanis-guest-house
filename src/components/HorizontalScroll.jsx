...
const Card = ({ card, t }) => {
  return (
    <div
      key={card.id}
      className="group grid grid-flow-dense md:grid-rows-none md:grid-cols-2 h-[720px] md:h-[650px] w-[350px] md:w-[700px] lg:w-[1300px] overflow-hidden bg-gradient-to-tl from-golden to-lightGreen"
    >
      <img
        src={card.url}
        alt="image"
