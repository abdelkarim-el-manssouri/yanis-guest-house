...
import { PhotosImages } from './../data/images_name'
            ...
            <div className="gallery">
                {
                    [...new Set(url_array)]?.map((el, i) => {
                        ...
                        return <div key={i} className={`element-item ${Math.floor((Math.random() * 3) + 1) == 2 ? 'tall' : ''} group overflow-hidden shadow-sm`}><img src={el} className='duration-200 group-hover:rotate-3 group-hover:scale-[1.3]' /></div>
